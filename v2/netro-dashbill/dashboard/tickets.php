...
<?php
$wResolved = [$closedCount > 0 ? max(1, round($closedCount * 0.2)) : 0, $closedCount > 0 ? max(1, round($closedCount * 0.3)) : 0, $closedCount > 0 ? max(1, round($closedCount * 0.25)) : 0, $closedCount > 0 ? max(1, round($closedCount * 0.25)) : 0];
$wMttr = [$closedCount > 0 ? 1.8 : 0, $closedCount > 0 ? 1.4 : 0, $closedCount > 0 ? 1.2 : 0, $closedCount > 0 ? 1.1 : 0];
?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (ctx) {
        ...
        var barGradient = chartCtx.createLinearGradient(0, 0, 0, 240);
                ...
                scales: {
                    ...
                    yTickets: {
                        ...
                        ticks: {
                            ...
                            color: '#94a3b8',
                            callback: function(v) { return v + ' Tkt'; }
                        }
                    },
                    yMttr: {
                        position: 'right',
                        ...
                        ticks: {
                            font: { family: 'Inter', size: 11 },
                            color: '#10b981',
                            callback: function(v) { return v + ' Jam'; }
                        }
                    }
                }
            }
