...
| [`CHANGELOG.md`](file:///d:/PG/BILL-DASH/docs/ai_context/CHANGELOG.md) | Riwayat versi, rilis modul, dan perubahan fitur NETPRO CRM (v1.0.0 s/d v4.0.0-ENTERPRISE). | Saat rilis versi atau penambahan fitur baru. |
