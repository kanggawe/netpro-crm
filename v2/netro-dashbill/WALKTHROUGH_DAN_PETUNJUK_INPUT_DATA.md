...
1. Buka browser: `http://localhost:8000/crm/paket.php` ([`crm/paket.php`](file:///d:/PG/BILL-DASH/crm/paket.php)).
2. Klik tombol **`+ Buat Paket Baru`** (Anda juga dapat mengedit atau menghapus paket yang ada).
