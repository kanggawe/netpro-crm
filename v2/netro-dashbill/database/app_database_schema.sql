-- ==========================================================
-- NETPRO CRM — Primary Application PostgreSQL Schema
-- Modules: CRM, Dual Billing, Finance PSAK, HR, Inventory, NOC
-- ==========================================================
...
-- 2. CUSTOMERS (Master Pelanggan & PPPoE Credentials Reference)
...
-- 8. NOC OUTAGES & FIBER CUT INCIDENTS
...
-- 9. TICKETS (Customer Support & Gangguan Lapangan)
...
-- 10. EMPLOYEES (Manajemen Karyawan & Teknisi)
...
-- 11. LEAVES (Pengajuan Cuti Karyawan)
...
-- 12. INVENTORY_ITEMS (Gudang Material ONT & Kabel Optik)
...
-- 13. CASH_TRANSACTIONS (Buku Kas & Transaksi Masuk/Keluar)
...
-- 14. LEADS (Prospek Sales & Calon Pelanggan)
...
-- 15. SETTINGS (Konfigurasi Global & Identitas Perusahaan)
CREATE TABLE IF NOT EXISTS settings (
    key VARCHAR(100) PRIMARY KEY,
    value TEXT NOT NULL
);

-- 16. USERS (Admin & RBAC Authentication)
...
-- 17. BRANCHES (Kantor Cabang Operasional ISP)
...
-- 18. COA_ACCOUNTS (Chart of Accounts Akuntansi PSAK)
...
-- 19. JOURNAL_ENTRIES (Jurnal Akuntansi Umum)
...
-- 20. TAX_RECORDS (Pajak PPh 23 / PPN Bupot)
...
-- 21. OPEX_EXPENSES (Pengeluaran Operasional)
...
-- 22. ATTENDANCES (Absensi GPS Pegawai)
...
-- 23. KPI_INDICATORS (Indikator Kinerja Karyawan)
...
-- 24. PERFORMANCE_REVIEWS (Review Nilai Kinerja)
...
-- 25. SALARY_COMPONENTS (Komponen Gaji & Tunjangan)
...
-- 26. PAYROLL_RECORDS (Slip Gaji & Penggajian Karyawan)
...
-- 27. BONUS_CLAIMS (Klaim Poin Insentif BAST)
...
-- 28. BACKUPS (Snapshot Cadangan Database)
...
-- 29. AUDIT_LOGS (Log Jejak Aktivitas Keamanan Sistem)
