...
* **Halaman**: [`pengaturan/perusahaan.php`](file:///d:/PG/BILL-DASH/pengaturan/perusahaan.php), [`crm/paket.php`](file:///d:/PG/BILL-DASH/crm/paket.php), [`crm/addon.php`](file:///d:/PG/BILL-DASH/crm/addon.php), & [`crm/promo.php`](file:///d:/PG/BILL-DASH/crm/promo.php).
* **Langkah Input**:
  1. Masukkan Nama Perusahaan (*PT NETPRO TELEKOMUNIKASI INDONESIA*), NPWP, Alamat HQ, dan Tarif PPN 11%.
  2. Daftarkan Katalog Paket Internet (dapat ditambah, diedit tarif/kecepatan/skema PPN, atau dihapus langsung di [`crm/paket.php`](file:///d:/PG/BILL-DASH/crm/paket.php)):
