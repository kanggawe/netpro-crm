...
<head>
    ...
    <style>
        ...
        .watermark-paid {
            color: rgba(16, 185, 129, 0.16) !important;
            border-color: rgba(16, 185, 129, 0.16) !important;
        }
        .watermark-unpaid {
            color: rgba(239, 68, 68, 0.16) !important;
...
<body class="py-6">
    ...
    <!-- Floating Top Control Bar (Hidden on Print & PDF) -->
    <!-- Floating Top Bar Controls (RedDash Theme) -->
        ...
        <div class="space-y-6">
            ...
            <header class="flex justify-between items-start border-b-2 border-slate-900 pb-5">
                <div class="space-y-1">
                    ...
                    <p class="text-slate-600 font-mono text-[11px] mt-1">NPWP / NPPKP: <strong><?= htmlspecialchars($companyNpwp) ?></strong></p>
                ...
                <div class="text-right space-y-1.5">
                    <h2 class="font-black text-brand-600 text-2xl tracking-wider uppercase">INVOICE</h2>
                    <div class="pt-0.5">
                        <?php if ($isPaid): ?>
