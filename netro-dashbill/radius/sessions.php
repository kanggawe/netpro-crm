...
$page_title = "SESSIONS";
$page_subtitle = "Halaman modul radius/sessions.html";
$active_menu = "m-radius";
require_once __DIR__ . '/../includes/header.php';
?>

<div id="view-radius-sessions" class="view-panel space-y-6" data-title="SESSIONS" data-subtitle="Halaman modul radius/sessions.php">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-5 text-xs">
            <div class="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-1">
                <span class="text-xs font-semibold text-slate-500 block uppercase">Total Metric SESSIONS</span>
            ...
            <div class="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-1">
                ...
                <span class="text-[11px] text-slate-400 font-medium">Tidak ada sesi aktif</span>
            </div>
        </div>

        <div class="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex justify-between items-center text-xs">
            <input type="text" placeholder="Cari data SESSIONS..." class="bg-slate-50 border border-slate-200 rounded-lg py-2 px-3 w-80">
            <button onclick="triggerToast('Tambah Data', 'Form tambah data dibuka.')" class="bg-blue-600 hover:bg-blue-700 text-white font-bold px-4 py-2 rounded-lg shadow">+ Tambah Entri SESSIONS</button>
        </div>

        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden text-xs">
            <div class="p-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                <h3 class="font-bold text-sm text-slate-900">Database Module: RADIUS / SESSIONS</h3>
                <span class="text-[10px] text-slate-400 font-mono">Modul radius/sessions.php</span>
            </div>
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-slate-50 text-slate-500 border-b border-slate-100 font-semibold">
                        <th class="py-3.5 px-5">ID Referensi</th>
                        <th class="py-3.5 px-5">Deskripsi Entri SESSIONS</th>
                ...
                <tbody>
                    <tr class="border-b border-slate-50">
                        <td colspan="6" class="py-8 text-center text-slate-400 font-medium">Belum ada data sesi RADIUS di database.</td>
                    </tr>
                </tbody>
            </table>
        </div>
