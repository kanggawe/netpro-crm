...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (ctx1) {
        ...
        var barGradient = chartContext.createLinearGradient(0, 0, 0, 300);
                        ...
                        callbacks: {
                            label: function(ctx) {
                                if (ctx.dataset.yAxisID === 'yRevenue') {
                                    ...
                                    return ' Pelanggan Baru: +' + ctx.raw + ' User';
                                }
                            }
                        }
                    }
    ...
    if (ctx2) {
        new Chart(ctx2.getContext('2d'), {
            type: 'doughnut',
            data: {
                labels: ['Home 20M', 'Home 50M', 'Gamer 100M', 'Dedicated Biz'],
                datasets: [{
                    data: [0, 0, 0, 0],
                    backgroundColor: ['#3b82f6', '#6366f1', '#22d3ee', '#10b981'],
                    hoverBackgroundColor: ['#2563eb', '#4f46e5', '#06b6d4', '#059669'],
                    borderWidth: 3,
                    borderColor: '#ffffff'
                }]
            },
